...
const StudentPerformancePredictionAddEdit = () => {
  ...
  useEffect(() => {
    dispatch(setBreadcrumb(["Education", "Student Performance Prediction", id]));
    return () => {
...
export default StudentPerformancePredictionAddEdit;
